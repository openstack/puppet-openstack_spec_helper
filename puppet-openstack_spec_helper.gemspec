...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'puppet-lint-lookup_in_parameter-check'
  spec.add_dependency 'puppet-lint-optional_default-check'
  spec.add_dependency 'puppet-lint-param-docs'
  spec.add_dependency 'puppet-lint-resource_reference_syntax'
  ...
  spec.add_dependency 'puppet-lint-version_comparison-check'
